...
public class ERoi extends PolygonRoi {
	...
	public void removeAllWireMouseAndMouseMotionListeners(ImagePlus newImage) {
	...
	public LiveWire getWire() {
		return wire;
	}

	public void setWire(LiveWire wire) {
		this.wire = wire;
	}
